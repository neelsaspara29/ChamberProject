...
<div class="wrapper">
    <div id="content" class="rightpad">
        ...
        <div style={{display: "flex", justifyContent: "center", flexDirection: "column", alignItems: "center"}}>
            ...
            <div class="phone"><a href="tel:954.462.4911"><span class="fa fa-phone-square"></span> 954.462.4911</a></div>
            <div class="email"><a href="mailto:dan@ftlchamber.com"><span class="fa fa-envelope"></span> dan@ftlchamber.com</a></div>
            <div class="clear"></div>
        </div>
    </div>
